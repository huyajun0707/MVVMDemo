...
public class ShareSDKUtil {
    ...
    public void defaultShare(Context context, String title, String content,
                             String imgUrl, String imgPath, String titleUrl, PlatformActionListener
                                     shareListener) {
     ...
     * @param shareListener 分享的回调
     */
    public void shareToQQ(String title, String content, String siteUrl, String imgUrl,
                          Bitmap bm, String imgPath, PlatformActionListener shareListener) {
