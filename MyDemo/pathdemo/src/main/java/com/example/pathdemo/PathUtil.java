...
public class PathUtil {
                ...
                case ConfigConstants.START_ITEM:
                    if (obj instanceof View) {
                        ...
                        if (ReflectorUtil.isInstanceOfV7RecyclerView(viewParent)) {
                            androidx.recyclerview.widget.RecyclerView recyclerView = (androidx.recyclerview.widget.RecyclerView) viewParent;
    ...
    public static int getChildPositionForRecyclerView(View child, ViewGroup group) {
        if ((ReflectorUtil.isV7RecyclerViewLoaded) && ((group instanceof androidx.recyclerview.widget.RecyclerView))) {
            androidx.recyclerview.widget.RecyclerView localRecyclerView = (androidx.recyclerview.widget.RecyclerView) group;
